...
export const schema = {
	...
	versionNotifications: {
		...
		endpoint: {
			...
			format: String,
			default: 'https://api.quicksales.vn/api/versions/',
			env: 'N8N_VERSION_NOTIFICATIONS_ENDPOINT',
		},
		infoUrl: {
			doc: "Url in New Versions Panel with more information on updating one's instance.",
			format: String,
			default: 'https://docs.quicksales.vn/getting-started/installation/updating.html',
	...
	templates: {
		...
		host: {
			...
			format: String,
			default: 'https://api.quicksales.vn/api/',
	...
	diagnostics: {
		...
		config: {
			...
			frontend: {
				...
				format: String,
				default: '1zPn9bgWPzlQc0p8Gj1uiK6DOTn;https://telemetry.quicksales.vn',
				env: 'N8N_DIAGNOSTICS_CONFIG_FRONTEND',
			},
			backend: {
				doc: 'Diagnostics config for backend.',
				format: String,
				default: '1zPn7YoGC3ZXE9zLeTKLuQCB4F6;https://telemetry.quicksales.vn/v1/batch',
	...
	license: {
		serverUrl: {
			format: String,
			default: 'https://license.quicksales.vn/v1',
