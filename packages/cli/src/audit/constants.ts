...
export const ENV_VARS_DOCS_URL = 'https://docs.quicksales.vn/reference/environment-variables.html';

export const DB_QUERY_PARAMS_DOCS_URL =
	'https://docs.quicksales.vn/integrations/builtin/app-nodes/n8n-nodes-base.postgres#use-query-parameters';

export const COMMUNITY_NODES_RISKS_URL = 'https://docs.quicksales.vn/integrations/community-nodes/risks';

export const SELF_HOSTED_AUTH_DOCS_URL = 'https://docs.quicksales.vn/hosting/authentication';
