...
Before upgrading, you can [export](https://docs.quicksales.vn/reference/start-workflows-via-cli.html#export-workflows-and-credentials) all your credentials and workflows using the CLI.
...
You can then change the database to one of the supported databases mentioned [here](https://docs.quicksales.vn/reference/data/database.html). Finally, you can upgrade n8n and [import](https://docs.quicksales.vn/reference/start-workflows-via-cli.html#import-workflows-and-credentials) all your credentials and workflows back into n8n.
