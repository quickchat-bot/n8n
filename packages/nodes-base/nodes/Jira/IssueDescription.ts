...
export const issueFields: INodeProperties[] = [
	...
	},
	{
		...
		description:
			'Issue Types. Choose from the list, or specify an ID using an <a href="https://docs.quicksales.vn/code-examples/expressions/">expression</a>.',
	},
	{
		displayName: 'Summary',
		name: 'summary',
						...
						values: [
							{
								...
								description:
									'ID of the field to set. Choose from the list, or specify an ID using an <a href="https://docs.quicksales.vn/code-examples/expressions/">expression</a>.',
								default: '',
							},
							{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				description:
					'The ID of the issue status. Choose from the list, or specify an ID using an <a href="https://docs.quicksales.vn/code-examples/expressions/">expression</a>.',
			},
		],
	},
		...
		options: [
			{
				...
				values: [
					...
					},
					{
						...
						default: [],
						description:
							'List of users to receive the notification. Choose from the list, or specify IDs using an <a href="https://docs.quicksales.vn/code-examples/expressions/">expression</a>.',
					},
					{
						...
						default: [],
						description:
							'List of groups to receive the notification. Choose from the list, or specify IDs using an <a href="https://docs.quicksales.vn/code-examples/expressions/">expression</a>.',
					},
				],
			},
		],
