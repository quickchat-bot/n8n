		...
		options: [
			{
				...
				description:
					'ID of the user who created the appointment. Choose from the list, or specify an ID using an <a href="https://docs.quicksales.vn/code-examples/expressions/">expression</a>.',
			},
			{
			...
			},
			{
				...
				description:
					'ID of outcome of Appointment sales activity type. Choose from the list, or specify an ID using an <a href="https://docs.quicksales.vn/code-examples/expressions/">expression</a>.',
			},
			{
