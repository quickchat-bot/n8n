...
export const billFields: INodeProperties[] = [
	...
	// ----------------------------------
	{
		...
		required: true,
		description:
			'The ID of the vendor who the bill is for. Choose from the list, or specify an ID using an <a href="https://docs.quicksales.vn/code-examples/expressions/">expression</a>.',
		default: [],
		typeOptions: {
