				...
				options: [
					{
						...
						default: 'multiple',
						description:
							'The way queries should be sent to database. Can be used in conjunction with <b>Continue on Fail</b>. See <a href="https://docs.quicksales.vn/integrations/builtin/app-nodes/n8n-nodes-base.timescaledb/">the docs</a> for more examples',
					},
					{
