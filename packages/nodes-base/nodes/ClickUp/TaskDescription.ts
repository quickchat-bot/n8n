	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description:
					'The array of tags applied to this task. Choose from the list, or specify IDs using an <a href="https://docs.quicksales.vn/code-examples/expressions/">expression</a>.',
			},
			{
