export const filters = (conditions: any) => [
	...
	},
	{
		...
		default: '',
		description:
			'List of users. Multiples can be defined separated by comma. Choose from the list, or specify an ID using an <a href="https://docs.quicksales.vn/code-examples/expressions/">expression</a>.',
	},
	{
		displayName: 'User Name or ID',
		name: 'createdByValue',
