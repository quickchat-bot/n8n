						...
						values: [
							{
								...
								default: '',
								description:
									'Column to apply the filter in. Choose from the list, or specify an ID using an <a href="https://docs.quicksales.vn/code-examples/expressions/">expression</a>.',
								required: true,
							},
							{
								displayName: 'Values',
						...
						values: [
							{
								...
								required: true,
								description:
									'Column to sort on. Choose from the list, or specify an ID using an <a href="https://docs.quicksales.vn/code-examples/expressions/">expression</a>.',
							},
							{
