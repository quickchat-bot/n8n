...
export class SplitInBatches implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			{
				displayName:
					'You may not need this node — n8n nodes automatically run once for each input item. <a href="https://docs.quicksales.vn/getting-started/key-concepts/looping.html#using-loops-in-n8n" target="_blank">More info</a>',
