				...
				options: [
					{
						...
						default: '',
						description:
							'Languages of the text input. If unspecified, the API will auto-detect the comment language. Choose from the list, or specify an ID using an <a href="https://docs.quicksales.vn/code-examples/expressions/">expression</a>.',
					},
				],
			},
		],
