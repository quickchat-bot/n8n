...
export const collectionFields: INodeProperties[] = [
	{
		...
		required: true,
		description:
			'Name of the collection to operate on. Choose from the list, or specify an ID using an <a href="https://docs.quicksales.vn/code-examples/expressions/">expression</a>.',
	},
