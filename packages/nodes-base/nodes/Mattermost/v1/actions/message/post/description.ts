...
export const messagePostDescription: MessageProperties = [
	{
		...
		description:
			'The ID of the channel to post to. Choose from the list, or specify an ID using an <a href="https://docs.quicksales.vn/code-examples/expressions/">expression</a>.',
	},
	{
		displayName: 'Message',
		name: 'message',
