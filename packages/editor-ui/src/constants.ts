...
export const N8N_IO_BASE_URL = 'https://api.quicksales.vn/api/';
export const DOCS_DOMAIN = 'docs.quicksales.vn';
...
export const N8N_PRICING_PAGE_URL = 'https://quicksales.vn/pricing';
...
Love n8n? Help us build the future of automation! https://quicksales.vn/careers
`;
