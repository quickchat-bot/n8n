...
n8n has 200+ different nodes to automate workflows. The list can be found on: [https://quicksales.vn/nodes](https://quicksales.vn/nodes)
...
[Server Setup](https://docs.quicksales.vn/#/server-setup) page.
